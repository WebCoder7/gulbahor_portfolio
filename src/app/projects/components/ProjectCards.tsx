...
export default function ProjectCards() {
  return (
    <div className='relative flex-1  bg-gradient-to-br from-pink-100 to-fuchsia-100 p-4 sm:p-6 md:p-8 lg:p-12 rounded-xl md:rounded-2xl xl:rounded-[2rem] shadow-lg md:shadow-2xl overflow-hidden'>
